namespace Facton.Spikes.ServiceApi.ODataMapping.WebFrameworks.WebApi.UriParsing
{
    ...
    /// </summary>
    public class PathSegmentDescriptionFactory : IPathSegmentDescriptionFactory<ODataPathSegment>
    {
        ...
        public PathSegmentDescription CreatePathSegmentDescription(ODataPathSegment segment, Func<PathSegment> getPreviouslyBuiltSegment)
        {
            var navigationSegment = segment as NavigationPathSegment;
            if (navigationSegment != null)
            {
                return new PathSegmentDescription(
                    PathSegmentDescription.PathSegmentKind.Navigation,
            ...
            {
                return new PathSegmentDescription(
                    PathSegmentDescription.PathSegmentKind.EntitySet,
            ...
            {
                return new PathSegmentDescription(
                    PathSegmentDescription.PathSegmentKind.Singleton,
            ...
            return
                new PathSegmentDescription(
                    keySegment != null ? PathSegmentDescription.PathSegmentKind.Key : PathSegmentDescription.PathSegmentKind.Unsupported,
                    null,
